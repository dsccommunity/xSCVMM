function Get-TargetResource
{
    ...
    $Version = (Get-CimInstance -Class Win32_Product | Where-Object {$_.Name -eq "Microsoft System Center Virtual Machine Manager Administrator Console (x64)"}).Version
...
function Test-TargetResource
{
    ...
    Write-Verbose -Message "Checking for presense of updates"
